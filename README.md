...
From analysis it is observed that there is not much difference between the two campaigns based on conversion of clicking customers to paying customers. However, there is a huge difference based on actual expenditure for each of the campaigns.  
